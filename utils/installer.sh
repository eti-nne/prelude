...
#   Defaults to 'https://github.com/jwintz/prelude.git'
# -i/--into
...
usage() {
    ...
    printf "  \t \t \t \t Defaults to 'https://github.com/jwintz/prelude.git'.\n"
...
[ -z $PRELUDE_URL ] && PRELUDE_URL="https://github.com/eti-nne/prelude.git"
