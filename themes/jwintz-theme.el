;;; prelude-jwintz-theme.el --- 
;; 
;; Author: Julien Wintz
;; Created: Sun Jan 27 23:00:57 2013 (+0100)
;; Version: 
;; Last-Updated: Wed Jan 30 20:52:11 2013 (+0100)
;;           By: Julien Wintz
;;     Update #: 31
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; 
...
;;; Based on wombat-theme.el --- Custom face theme for Emacs
;;; -*-coding: utf-8 -*-
...
(deftheme jwintz
  "Medium-contrast faces with a dark gray background. Based on wombat")
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   ;; Defaults
   `(default ((,class (:background "#141414" :foreground "#f6f3e8"))))
   ...
   `(highlight ((,class (:background "#454545" 
                         :foreground "#ffffff"))))
   `(region ((,class (:background "#222222" :foreground "#f6f3e8"))))
   ...
   `(header-line ((,class (:foreground "#e7f6da"))))
...
(provide-theme 'jwintz)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; prelude-jwintz-theme.el ends here
